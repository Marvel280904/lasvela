export type Product = {
  ...
  features: string[]
  images: string[]
  thumbnailImage?: string // Selected thumbnail image URL
  careInstructions?: string[]
  deliveryTime?: string
  warranty?: string
  inStock: boolean
  isVisible: boolean // Control visibility in public catalog
...
export type MaterialOption = {
  name: string
  description?: string
  image?: string // Add image field for material-specific images
}
...
export type OrderStatus = "pending" | "payment_initiated" | "paid" | "processing" | "shipped" | "delivered" | "cancelled" | "refunded"
...
export type Order = {
  ...
  paymentId?: string // HitPay payment ID
  paymentStatus?: string // Payment status from HitPay
  paymentProvider?: string // Payment provider (e.g., "hitpay")
  notes?: string
